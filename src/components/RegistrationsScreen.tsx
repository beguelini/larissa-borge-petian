...
type Registration = { id: string; firstName: string; email: string; whatsapp: string | null; initials: string; date: string; time: string; dosha: Dosha; secondaryDosha: Dosha | null; isBalanced: boolean; marketingConsent: boolean }
