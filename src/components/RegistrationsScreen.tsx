...
type Registration = { firstName: string; email: string; initials: string; date: string; time: string; dosha: Dosha; secondaryDosha: Dosha | null; isBalanced: boolean; marketingConsent: boolean }
